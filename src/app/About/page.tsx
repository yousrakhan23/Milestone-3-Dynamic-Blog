...
import myProfile from "../../../public/images/mine2.jpg";
...
const About = () => {
  return (
    <section className="text-slate-400 body-font overflow-hidden bg-gray-100 dark:bg-[#181A2A]">
      <div className="container mx-auto px-5 py-24">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between space-y-10 lg:space-y-0 lg:space-x-10">
          ...
          <div className="w-full lg:w-2/3 text-center lg:text-left">
            <h1
              className={`${rubikVinyl.className} text-5xl font-serif font-bold text-[#F2AE66] cursor-pointer transition-colors duration-500`}
            >
              About Me
            </h1>
